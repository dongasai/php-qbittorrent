...
use Dongasai\qBittorrent\Request\Torrent\DeleteTorrentsRequest;
use Dongasai\qBittorrent\Request\Torrent\PauseTorrentsRequest;
use Dongasai\qBittorrent\Request\Torrent\ResumeTorrentsRequest;
use Dongasai\qBittorrent\Response\Torrent\TorrentListResponse;
...
class TorrentAPI implements ApiInterface
{
     ...
     * @return \Dongasai\qBittorrent\Contract\ResponseInterface 添加响应
     * @throws NetworkException 网络异常
     * @throws ValidationException 验证异常
     * @throws ApiRuntimeException API运行时异常
     */
    public function addTorrents(AddTorrentRequest $request): \Dongasai\qBittorrent\Contract\ResponseInterface
    {
        // 验证请求
        $validation = $request->validate();
        if (!$validation->isValid()) {
     ...
     * @return \Dongasai\qBittorrent\Contract\ResponseInterface 删除响应
     * @throws NetworkException 网络异常
     * @throws ValidationException 验证异常
     * @throws ApiRuntimeException API运行时异常
     */
    public function deleteTorrents(DeleteTorrentsRequest $request): \Dongasai\qBittorrent\Contract\ResponseInterface
    {
        // 验证请求
        $validation = $request->validate();
        if (!$validation->isValid()) {
     ...
     * @return \Dongasai\qBittorrent\Contract\ResponseInterface 暂停响应
     * @throws NetworkException 网络异常
     * @throws ValidationException 验证异常
     * @throws ApiRuntimeException API运行时异常
     */
    public function pauseTorrents(PauseTorrentsRequest $request): \Dongasai\qBittorrent\Contract\ResponseInterface
    {
        // 验证请求
        $validation = $request->validate();
        if (!$validation->isValid()) {
     ...
     * @return \Dongasai\qBittorrent\Contract\ResponseInterface 恢复响应
     * @throws NetworkException 网络异常
     * @throws ValidationException 验证异常
     * @throws ApiRuntimeException API运行时异常
     */
    public function resumeTorrents(ResumeTorrentsRequest $request): \Dongasai\qBittorrent\Contract\ResponseInterface
    {
        // 验证请求
        $validation = $request->validate();
        if (!$validation->isValid()) {
