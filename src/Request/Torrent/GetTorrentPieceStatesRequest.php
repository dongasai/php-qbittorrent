...
/**
 * 获取Torrent Piece状态请求对象
 *
 * 用于获取指定torrent的所有piece状态
 */
class GetTorrentPieceStatesRequest extends AbstractRequest
{
    ...
    protected function __construct(string $hash)
    {
        ...
        $this->setEndpoint('/torrents/pieceStates')
             ->setMethod('GET');
    }
     ...
     * 创建Builder实例
     *
     * @return GetTorrentPieceStatesRequestBuilder Builder实例
     */
    public static function builder(): GetTorrentPieceStatesRequestBuilder
    {
        return new GetTorrentPieceStatesRequestBuilder();
    }
...
/**
 * 获取Torrent Piece状态请求构建器
 *
 * 使用Builder模式创建GetTorrentPieceStatesRequest实例
 */
class GetTorrentPieceStatesRequestBuilder
{
    ...
    /**
     * 构建GetTorrentPieceStatesRequest实例
     *
     * @return GetTorrentPieceStatesRequest 请求实例
     * @throws ValidationException 如果参数无效
     */
    public function build(): GetTorrentPieceStatesRequest
    {
        if ($this->hash === null) {
            throw ValidationException::missingParameter('hash');
        }

        $request = new GetTorrentPieceStatesRequest($this->hash);
